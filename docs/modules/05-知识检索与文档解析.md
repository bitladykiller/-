...
| `shared/task_queue.py` | 异步 `process_file` 状态机 |
...
见 [02-API接口.md](02-API接口.md) 上传流程；任务状态流转直接看源码 `app/shared/task_queue.py`。
