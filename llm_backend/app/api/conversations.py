...
from app.services.conversation_service import ConversationService, ConversationSummary
...
def _build_created_response(conversation_id: int) -> ConversationCreatedResponse:
    """统一构造创建会话成功响应。"""
...
async def create_conversation(
    ...
    return _build_created_response(conversation_id)
