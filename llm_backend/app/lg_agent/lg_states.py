...
class AgentState(InputState):
    ...
    v3.17 优化：新增 memory_state 字段，在首次加载后缓存，避免一条请求中多次调用
    middleware.before_agent() 导致的重复 Redis STM + MySQL Profile + Milvus LTM 开销。
    """
    # Router 输出
    ...
    # 记忆上下文缓存 — 首次 enrich_question 或 respond_to_general_query 时填充，
    # 后续节点复用，避免重复查询 Redis/MySQL/Milvus
