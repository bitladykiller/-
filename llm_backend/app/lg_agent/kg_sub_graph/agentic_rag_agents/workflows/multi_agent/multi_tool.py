...
# 导入 RAG 文档检索节点（替代原 GraphRAG customer_tools）
from app.lg_agent.kg_sub_graph.agentic_rag_agents.components.customer_tools import create_rag_search_node
...
def create_multi_tool_workflow(
    ...
    # 3. 创建cypher_query节点（内嵌 Text2Cypher 子图，含 5 层验证）
    ...
    customer_tools = create_rag_search_node()
