...
def _build_memory_schema(milvus_client):
...
def _build_memory_index_params(milvus_client):
...
def ensure_memory_collection(
    ...
    milvus_client.create_collection(
        ...
        schema=_build_memory_schema(milvus_client),
        index_params=_build_memory_index_params(milvus_client),
    )
    return True
